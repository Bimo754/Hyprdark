...
Item {
    ...
    ParallelAnimation {
        ...
        SequentialAnimation {
            ...
            ParallelAnimation {
                NumberAnimation { target: engineRoot; property: "scaleX"; to: engineRoot.physics.teardropScaleX; duration: 160; easing.type: Easing.OutQuad }
                NumberAnimation { target: engineRoot; property: "scaleY"; to: engineRoot.physics.teardropScaleY; duration: 160; easing.type: Easing.OutQuad }
            }
            // Splash squash on touchdown
            ParallelAnimation {
                NumberAnimation { target: engineRoot; property: "scaleX"; to: engineRoot.physics.landingSquashX; duration: 110; easing.type: Easing.OutQuad }
                NumberAnimation { target: engineRoot; property: "scaleY"; to: engineRoot.physics.landingSquashY; duration: 110; easing.type: Easing.OutQuad }
            }
            // Rebound settle
            ParallelAnimation {
                NumberAnimation { target: engineRoot; property: "scaleX"; to: 1.0; duration: 130; easing.type: Easing.OutBack; easing.overshoot: 1.25 }
                NumberAnimation { target: engineRoot; property: "scaleY"; to: 1.0; duration: 130; easing.type: Easing.OutBack; easing.overshoot: 1.25 }
            }
        }
    ...
    ParallelAnimation {
        ...
        // Horizontal pinch back to circle
        SequentialAnimation {
            ParallelAnimation {
                NumberAnimation {
                    target: engineRoot
        ...
        // Overlapping Upward Suction & Uniform Aperture Shrink
        SequentialAnimation {
            ...
            ParallelAnimation {
                ...
                SequentialAnimation {
                    ParallelAnimation {
                        NumberAnimation { target: engineRoot; property: "scaleX"; to: 1.04; duration: 45; easing.type: Easing.OutQuad }
                        NumberAnimation { target: engineRoot; property: "scaleY"; to: 1.04; duration: 45; easing.type: Easing.OutQuad }
                    }
                    ParallelAnimation {
                        NumberAnimation { target: engineRoot; property: "scaleX"; to: 0.18; duration: 175; easing.type: Easing.InQuad }
                        NumberAnimation { target: engineRoot; property: "scaleY"; to: 0.18; duration: 175; easing.type: Easing.InQuad }
                    }
                    ParallelAnimation {
